...
public final class Assertions {
  ...
  private static boolean verifyApplicationThreadDisabled;

  private static Consumer<Boolean> checkState = (expression) -> {
  ...
  public static void verifyApplicationThreadDisable(boolean on)
  {
    verifyApplicationThreadDisabled = on;
    if(verifyApplicationThreadDisabled)
      checkState = (e) -> {};
    else
  ...
  public static boolean verifyApplicationThreadIsDisabled()
  {
    return verifyApplicationThreadDisabled;
  }
